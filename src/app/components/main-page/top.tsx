...
export default function Top() {
    ...
    const bio2 = `My core skills are javascript, nodejs, and Angular which I am currently top 1% on StackOverflow. Even though I am specialized in Angular I am a believer in clean code and I am not attached to any technology or language. I am currently living in Florianópolis but I am willing to move or work remotely. I am looking for a senior or tech lead position.`
    return (
        <section>
            <div className='container mt-0'>
                <div className='flex  columns-2 text-lg'>
